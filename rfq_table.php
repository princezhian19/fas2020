      ...
      <div class="panel panel-default">
        <div class=""> 
          <div class="">
            ...
            &nbsp&nbsp&nbsp&nbsp&nbsp<li class="btn btn-success"><a href="CreateRFQ.php" style="color:white;text-decoration: none;">Create</a></li>
            <br>
            <br>
                ...
                while ($row = mysqli_fetch_assoc($view_query)) {
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         &nbsp&nbsp&nbsp&nbsp&nbsp<a  href='/pmis/frontend/web/rfq/update?id=<?php echo $id; ?>' title="View"> <i style='font-size:20px' class='fa'>&#xf044;</i> </a>
