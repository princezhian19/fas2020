...
if ($conn->connect_error) {
  ...
  $query = mysqli_query($conn,"INSERT INTO travel_order (tono,date,office,name,purpose,place,todate,timefrom,timeto) 
  VALUES ('$tono','$date','$office','$name','$purpose','$place','$todate','$timefrom','$timeto')");
               ...
               <!--  <table class="table"> 
                ...
                <input hidden  class="" type="text" class="" style="height: 35px;" id="check" name="check" placeholder="check" >
                    ...
                    <tr>  
                            ...
                            <td class="col-md-5">
                            <input required value="<?php echo $obcount; ?>" readonly  class="form-control" type="text" class="" style="height: 35px;" id="tono" name="tono" placeholder="obno" >
                            </td>
                    </tr>
                    <tr>
