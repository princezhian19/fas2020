            ...
            $('.select2').on('change', function()
              ...
              var table = $('#example').DataTable( {
                ...
                "bAutoWidth": false,
                  "processing": true,
                  "serverSide": false,
                  "ajax": "DATATABLE/c_processing.php",
                  "order": [[ 0, "desc" ]],
                  "columnDefs": [ {
                      "targets": 7,
                      "render": function (data, type, row, meta ) {  

                     action = '<button class = "btn btn-success" id = "edit" ><i class = "fa fa-eye"></i>View</button>';
              ...
              $('#example tbody').on( 'click', '#edit', function () {
                ...
                window.location="report/TA/pages/viewCSS.php?CONTROL_NO="+data[0];
              } );
