    ...
    <div class="">
      <div class="panel panel-default">
        <div class=""> 
          <div class="">
            <br>
            <h1 align="">&nbspManage Employee List</h1>
            ...
            <form method="POST">
                <table id="example1" class="table table-striped table-bordered" style="width:;background-color: white;">
                    ...
                    <?php 
                    $view_query = mysqli_query($conn, "SELECT te.id,te.l_name,te.f_name,te.m_name,te.ext_name,te.designation,te.employment_date,td.bir,td.rlip,td.philhealth,td.pagibig_premium FROM tbl_employee te LEFT JOIN tbl_deductions td on te.emp_no = td.emp_no WHERE te.status = 0 order by te.l_name ASC ");
            ...
            <div style="padding: 18px;">
             <button class="btn btn-danger "   type="submit" name="delete">Delete</button> Or  <button class="btn btn-primary "   type="submit" name="retire">Retire</button> Or  <button class="btn btn-warning "   type="submit" name="resign">Resign</button> Or <button class="btn btn-info "   type="submit" name="leave">Leave Wihtout Pay</button> 
         </div>
