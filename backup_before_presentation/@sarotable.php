...
<body>
    ...
    <div class="class"  style="overflow-x:auto;">
         ...
         <div class="col-md-1">
          ...
          <!-- <input type="text" class="form-control" style="height: 35px; width: 350px" id="myInput" onkeyup="myFunction()" placeholder="Search Here" >
            ...
            <table id="example1" class="table table-striped table-bordered" style="background-color: white;">
                <thead>
                    <tr style="background-color: white;color:blue;">
                        ...
                        <th style="text-align:center" width="800">SOURCE</th>
                        <th style="text-align:center" width="800">FUND</th>
                        <th style="text-align:center" width="800">LEGAL BASIS</th>
                        <th style="text-align:center" width="800">PPA</th>
                        <th style="text-align:center" width="800">EXPENSE CLASS</th>
                        <th style="text-align:center" width="800">PARTICULARS</th>
            ...
            $view_query = mysqli_query($conn, "SELECT * FROM saro order by sarodate desc");
                ...
                while ($row = mysqli_fetch_assoc($view_query)) {
                  ...
                  echo "<tr align = ''>
                    ...
                    <a href='@Functions/sofexport.php?getid=$id'> <i style='font-size:24px' class='fa fa-fw fa-download'></i>Export </a>
                    </td>
