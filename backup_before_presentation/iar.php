...
$sql2 = mysqli_query($conn,'INSERT INTO iar_stock(rfq_id,app_id,procurement,description,unit_id,qty,abc,qty_original,abc_original)
                 SELECT rfq_id,app_id,procurement,description,unit_id,qty,abc,qty,abc FROM rfq_items left join app on app.id = rfq_items.app_id where rfq_id = "'.$rfq_id.'"');
