      ...
      <div class="box-body">
        <div class="well">
            ...
            <form method="POST" id="">
              ...
              <form method="POST" id="">
                ...
                <div class="col-xs-3">
                  ...
                  <input type="text"  class="form-control" style="height: 40px;" id="division" placeholder="" name="division" disabled>
                </div>
                <div class="col-xs-3">
                  <label>PO No. : </label>
         ...
         <!--    <div class="col-xs-3">
            ...
            <div class="col-xs-3">
              <label>Requested by : </label>
              <input type="text"  name="request_by" id="request_by" class="form-control" disabled>
