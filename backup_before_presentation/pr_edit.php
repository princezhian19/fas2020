...
$query = mysqli_query($conn,"SELECT a.procurement,i.item_unit_title,description,qty,unit,abc from pr_approved pa left join app a on a.id = pa.items left join item_unit i on i.id = pa.unit  where pa.id = '$id' ");
...
<div class="box box-default">
  <div class="box-header with-border">
    ...
    <br>
    &nbsp &nbsp &nbsp   <li class="btn btn-success"><?php echo '<a href="ViewPRdetails.php?pr_no='.$pr_no.'&pmo='.$pmo.'&pr_date='.$pr_date.'&purpose='.$purpose.'" style="color:white;text-decoration: none;">Back</a>' ?> </li>

    <li class="btn btn-info"><?php echo '<a href="CreatePr.php?pr_no='.$pr_no.'&pmo='.$pmo.'&pr_date='.$pr_date.'&purpose='.$purpose.' " style="color:white;text-decoration: none;">Add More Items</a>' ?></li>
    <br>
    <br>
    <form method="POST" >
      <div class="box-body">
