...
<body>
      ...
      <div class="panel panel-default">
        <div class="responsive"> 
          <div class="responsive">
            ...
            <h1 align="">&nbspStatus Of Funds</h1>
    ...
    <div class="section group">
          ...
          <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
                    ...
                    $(document).ready(function(){
                      $("#myInput").on("keyup", function() {
                        ...
                        $("#tableSearch th ").filter(function() {
                          $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                        });
                      });
                    });
      ...
      <!-- table here -->
            ...
            <table id="tableSearch" class="table-responsive table-striped table-bordered" style="background-color: white;">
                <thead>
                    <tr style="background-color: white;color:blue; text-align: center;">
                        <th width="50" style="text-align: center;"></th>
                        <!-- <th width="800">DATE RECEIVED</th> -->
                        <th width="500">DATE PROCESSED</th>
