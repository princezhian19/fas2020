...
$id = $_GET['id'];
$sql = mysqli_query($conn, "SELECT * FROM ris WHERE id = '$id' ");
...
$sql_items = mysqli_query($conn, "SELECT procurement,description,unit_id,qty,qty_original,remarks FROM `ris_stock` LEFT JOIN ris on ris.ris_no = ris_stock.ris_no WHERE ris_stock.ris_no LIKE '$ris_no'"); 
