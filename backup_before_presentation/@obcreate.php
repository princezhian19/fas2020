  ...
  <form class="" type='GET' action="@Functions/obcreatefunction.php" >
        ...
        <div class="class-bordered" >
            <div class="row">
                <div class="col-md-6">
                      ...
                      <input  type="text" class="form-control" style="height: 35px;" id="" placeholder="Enter ORS Number" name="ors">
                      <br>
                      <label>PO No.</label>
            ...
            <script type="text/javascript">
              $(document).ready(function(){
                ...
                $('#ponum').keyup(function(){
                  ...
                  {
                    document.getElementById('payee'+[i]).value = "";
              ...
              function showRow(row)
              {
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" id="" placeholder='Enter Date' name="datereprocessed">
                        <br>
                    </div>
                </div>
            </div>
        ...
        <div class="class">
            ...
            <div class="row">
                ...
                <label>Date Returned</label>
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" id="" placeholder='Enter Date' name="datereturned">
                    </div>
                    <br>
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" id="" placeholder='Enter Date' name="datereleased">
                        <br>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <label>MFO/PPA</label>
                    <input  type="text"  class="form-control" style="height: 40px;" id="ppa" placeholder="PPA" name="ppa">
              ...
              function showRow3(row)
              {
                ...
                <div class="col-md-3">
                    ...
                    <input  type="text"  class="form-control" style="height: 40px;" id="uacs" placeholder="UACS Code" name="uacs">
