...
<body>
      ...
      <div class="panel panel-default">
        <div class="class-responsive"> 
          <div class="class-responsive">
            ...
            <h1 align="">&nbspSupplies Ledger</h1>
    ...
    <div class="class-responsive">
        ...
        &nbsp&nbsp&nbsp&nbsp&nbsp<input  type="text" class="" style="height: 35px; width: 400px" id="stocksearch" placeholder="Search Stock No. Here" name="stocksearch" autofocus>
         &nbsp&nbsp&nbsp<button type="submit" name="submit" style="width:%; height: 35px" class="btn btn-success ">Search</button>
          </form>
        </div>
        </div>
