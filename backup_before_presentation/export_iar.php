...
$sql_items = mysqli_query($conn, "SELECT sn,unit_id,qty,procurement,abc,description from rfq_items left join app on app.id = rfq_items.app_id where rfq_id = '$rfq_id'");
$piece = "piece";
$box = "box";
$ream = "ream";
$lot = "lot";
