            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" id="" placeholder='Enter Date' name="datereceived" value="" required>
                    </div>
                    <br>
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" id="" placeholder='Enter Date' name="datereprocessed" value="" required>
                        <br>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <label>Date Returned</label>
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" id="" placeholder='Enter Date' name="datereturned" value="" >
                    </div>
                    <br>
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" id="" placeholder='Enter Date' name="datereleased" value="" required>
                        <br>
                    </div>
