  ...
  <div class="box-body">
          ...
          <br>
            ...
            // Create connection
              ...
              $view_query = mysqli_query($conn, "SELECT dv,ors,datereceived,date_proccess,datereleased,payee,particular,sum(amount) as amount, total, net, remarks, status,flag,orsdate  FROM disbursement group by ors order by datereleased asc");
