                    ...
                    <form method="POST" enctype="multipart/form-data" class="myformStyle" autocomplete="off" id = "submit">    
                     ...
                     <br>
                        ...
                        <table border = 1 style = "margin-top:20px;width:100%;">
                          ...
                          <tr>
                              <td colspan = 4 >
                              <textarea   rows="23" name = "issue" cols="56"  style ="border:5px solid red;background-color:#EEEEEE;resize:none;width:100%;" >
                              <?php echo showIssue(); ?>
                              </textarea>
                              </td>

                              <td colspan = 4 rowspan= 2>
                              <textarea class = "disabletxtarea" id ="diagnose" rows="25" cols="56" style ="resize:none;width:100%;align-content:left;" name = "STATUS_DESC">
...
switch ($row['STATUS']) {
  case '1':
    ...
    <td colspan=2 class = "label-text">
      <input disabled type = "checkbox"  class = "checkbox_group" id = "resolved" name = "isComplete" value = "1" checked/>
    &nbsp;&nbsp;&nbsp;&nbsp;Resolved<span style = "color:red;">*</span>
  </td>
    <td colspan=2 class = "label-text">
    <input disabled type = "checkbox" class = "checkbox_group" id = "defective" name = "isComplete" value = "0" />&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  case '0':
    ?>
    <td colspan=2 class = "label-text">
      <input disabled type = "checkbox"  class = "checkbox_group"  id = "resolved" name = "isComplete" value = "1" />
    &nbsp;&nbsp;&nbsp;&nbsp;Resolved<span style = "color:red;">*</span>
  </td>
    <td colspan=2 class = "label-text">
    <input disabled type = "checkbox" class = "checkbox_group" id = "defective" name = "isComplete" value = "0" checked/>&nbsp;&nbsp;&nbsp;&nbsp;
    Defective(to be referred to GSS for repair)<span style = "color:red;">*</span>
    </td>
    <?php
    break;
   ...
   <?php
    break;
                         ...
                         ?>
                          ...
                          <input disabled type="text" name = "completed_date" id = "completed_date" class="datePicker1" value="<?php echo setCompletedDate();?>" required>
                          </div>
                          </td>
                          ...
                          <input disabled style = "width:100%;" id= "timepicker" type="time" name = "started_time"  value="<?php echo setStartTime(); ?>" required>
                        ...
                        <input disabled style = "width:100%;"  id = "timepicker2" type="time" name = "completed_time"   value="<?php echo setCompletedTime();?>" required>
