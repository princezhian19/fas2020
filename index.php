...
$pas1 = $_SESSION['pass'];
    $sqlUsername = mysqli_query($conn,"SELECT CODE,EMP_N,isPlanningOfficer FROM tblemployeinfoinfo WHERE md5(UNAME) = '".md5($username)."' LIMIT 1");
  ...
  // ===============================================
  $query = "SELECT * FROM tblemployeinfoinfo WHERE UNAME = '".$username."' AND PSWORD = '".$pas1."' AND BLOCK = 'N' LIMIT 1 ";
...
if (isset($_POST['submit'])) {
  ...
  $username = $_SESSION['username'];
  $sqlUsername = mysqli_query($conn,"SELECT CODE,EMP_N,isPlanningOfficer FROM tblemployeinfoinfo WHERE md5(UNAME) = '".md5($_POST['username'])."' LIMIT 1");
  ...
  // ===============================================
  $query = "SELECT * FROM tblemployeinfoinfo WHERE md5(UNAME) = '".md5($_POST['username'])."' AND PSWORD = '".$password."' AND  BLOCK = 'N' LIMIT 1 ";
  $result = mysqli_query($conn, $query);
  $val = array();
  // $numrows= mysqli_num_rows($query);
  if ($result->num_rows > 0) {
