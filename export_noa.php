...
'We are pleased to inform you that your Quotation for the Procurement of '.$purpose.'with Purchase Order equivalent to Php '.number_format($totalABC,2).' is hereby accepted. ');
