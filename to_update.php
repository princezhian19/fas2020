...
$query = mysqli_query($conn,"UPDATE  travel_order set tono='$tono',date='$date',office='$office',name='$name',purpose='$purpose',place='$place',todate='$todate',timefrom='$timefrom1',timeto='$timeto1',uc='0' where id = '$id'");
              ...
              <!--   <table class="table"> 
                ...
                <input value="<?php echo $id;?>" hidden  type="text"  class="" style="height: 35px;" id="getid" placeholder="" name="getid">
                    ...
                    <tr>  
                            ...
                            <td class="col-md-5">
                            <input readonly value="<?php echo $tono;?>" required  class="form-control" type="text" class="" style="height: 35px;" id="tono" name="tono" placeholder="tono" >
                                    </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                            ...
                            <td class="col-md-5">
                            <input required  value="<?php echo $place;?>" id="place" name="place" autocomplete ="off" type="text" class="form-control" placeholder="place">
                            </td>
                    </tr>
                    ...
                    <tr>
                          ...
                          <td class="col-md-5">
                          <input value="<?php echo $todate;?>" required type="text" class="form-control" style="height: 35px;" name="todate" id="datepicker2"  placeholder="mm/dd/yyyy">
                          </
                    </tr>
