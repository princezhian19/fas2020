...
function getDivision()
{
  ...
  $sqlUsername = mysqli_query($conn,"SELECT * FROM  tblemployeinfoinfo INNER JOIN tblpersonneldivision ON tblemployeinfoinfo.DIVISION_C = tblpersonneldivision.DIVISION_N where  UNAME ='".$_SESSION['username']."'");
