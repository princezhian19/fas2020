  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <table id="example1" class="table table-bordered-striped table-bordered" style="width:;background-color: white;">
        ...
        $view_query = mysqli_query($conn, "SELECT burs.status,burs.id,pmo.pmo_title,burs.po_no,burs.supplier,burs.address,burs.purpose,burs.amount FROM burs LEFT JOIN pmo on pmo.id = burs.office WHERE burs.status = 3 order by burs.id desc ");
            ...
            <td><?php 
              echo '
                   <a class="btn btn-danger btn-xs"
                    href="ViewBURScomments.php?id='.$id.' "> <b>Returned</b> </a>
              ';
            ?>
          </td>
          <td>
            <a class="btn btn-primary btn-xs" href='UpdateBURS.php?id=<?php echo $id; ?>&btn=no' > View </a>
