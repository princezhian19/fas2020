...
<body>
  <div class="box box-default">
    ...
    &nbsp &nbsp &nbsp   <li class="btn btn-success"><a href="ViewPRv.php" style="color:white;text-decoration: none;">Back</a></li>
      ...
      &nbsp &nbsp &nbsp   <li class="btn btn-info"><?php echo '<a href="CreatePr1.php?pr_no='.$pr_no.'&pmo='.$pmo.'&pr_date='.$pr_date.'&purpose='.$purpose.' " style="color:white;text-decoration: none;">Add More Items</a>' ?></li>
      <br>
      <br>
      <form method="POST">
        <div class="box-body">
