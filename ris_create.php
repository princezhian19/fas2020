...
<body style="background: lightgray;" >
 ...
 <div class="w3-sidebar w3-bar-block  w3-card" style="width:230px;">
    ...
    <div>
      <p class="active" href="#home" style="text-align:right;padding-right:90px;padding-top:10px;padding-bottom:10px;background-color: #0072C7;color:white;font-size: 20px;">&nbsp&nbsp&nbspAMS</p>
    </div>
    &nbsp&nbsp&nbsp<img src="to.png" width="45" height="45">&nbsp <b style="font-size: 12px;">
    &nbsp&nbsp&nbspAsset Management</b>
    <p> &nbsp</p>
...
<a style="color:gray;font-weight: normal;" href="#">Create Requisition and Issue Slip</a>
</div>
<p></p>
