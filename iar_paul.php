...
<head>
  ...
  <script type="text/javascript">
    ...
    function showRow(row)
    {
      ...
      document.getElementById("po").value = x[4].innerHTML;
...
<body style="background: lightgray;">
  <div class="">
    ...
    <br>
      ...
      <div class="col-xs-3">
        <label>PO No. : </label>
        <input readonly type="text" class="form-control" style="height: 40px;" id="po" placeholder="" name="po">
      </div>
      <div class="col-xs-3">
        <label>PO Date : </label>
...
$sql2 = mysqli_query($conn,'INSERT INTO iar_stock(rfq_id,app_id,procurement,description,unit_id,qty,abc,qty_original,abc_original) SELECT app.procurement,rfq_items.app_id,rfq_items.rfq_id,rfq_items.description,rfq_items.unit_id,rfq_items.qty,rfq_items.abc,rfq_items.qty,rfq_items.abc FROM app left join rfq_items on app.id = rfq_items.app_id where rfq_id = "'.$rfq_id.'"');
