...
<body>
    ...
    <div class="class-responsive">
         ...
         <div class="col-md-5">
          &nbsp &nbsp &nbsp   <li class="btn btn-success"><a href="@stockledger.php" style="color:white;text-decoration: none;">Back</a></li>
          </div>
          <div class="col-md-0">
        ...
        <div class="col-md-7">
          <!-- <form method = "POST" action = "@Functions/supplyledgerexpot.php"> -->
          <form method = "POST" action = "@Functions/supplyledgerexpot.php">
