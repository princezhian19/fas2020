...
$objPHPExcel->setActiveSheetIndex()->setCellValue('A45',$supplier_title);
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('A23',$supplier_title.' that the asd for the'.$pmo.' shall commence upon receipt of the  ');
