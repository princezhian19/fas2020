        ...
        <div class=""> 
          <div class="">
            ...
            <h1 align="">&nbspResult at Stock No. : <?php echo $stocksearch; ?></h1>
             ...
             <li class="btn btn-success"><a href="@stockledger.php" style="color:white;text-decoration: none;">Back</a></li>
    </div>
    <br>
    <div class="class">
        ...
        <div class="col-md-1">
          ...
          <form method = "POST" action = "@Functions/obexportall.php">
            <!-- &nbsp&nbsp&nbsp<button type="submit" hdden name="submit"  class="btn btn-success ">Export All</button> -->
          </form>
        </div>
      </div>
      <br>
