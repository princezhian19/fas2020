...
$do = "UPDATE saroobburs set datereceived='$datereceived11',
...
/* echo "UPDATE saroobburs set datereceived='$datereceived11',
datereprocessed='$datereprocessed11', 
datereturned='$datereturned11',
datereleased='$datereleased11',
burs='$burs',
...
$query1 = mysqli_query($conn,"SELECT sum(amount) as total FROM  saroobburs where saronumber = '$saronumber' and uacs = '$uacs' ");
