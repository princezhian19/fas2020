...
if (isset($_POST['submit'])) 
{
  ...
  if($_POST['datefrom']==""){
    ...
    window.alert('Error - Date cannot be empty!')
...
$sql_items = mysqli_query($conn, "SELECT * FROM saro where sarodate  between '$d1' and '$d2' order by sarodate asc ");
...
header('location: sarodateexport.xlsx');
}
