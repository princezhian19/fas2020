...
$conn=mysqli_connect("localhost","root","","fascalab_2020");
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('E12',"For the Month of :     ".$d3);
...
//set width, height
  ...
  header('location: ddateexport.xlsx');
...
if (isset($_POST['submit'])) 
{
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('G9',$d3);
...
if (mysqli_num_rows($sql_items)>0) {
    ...
    $objPHPExcel->setActiveSheetIndex()->setCellValue('G'.$row,$datefromormat);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('H'.$row,$timeFormat);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('I'.$row,$excelrow['payee']);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('J'.$row,$excelrow['particular']);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('K'.$row,$excelrow['amount']);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('L'.$row,$excelrow['tax']);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('M'.$row,$excelrow['gsis']);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('N'.$row,$excelrow['pagibig']);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('O'.$row,$excelrow['philhealth']);
