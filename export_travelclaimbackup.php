...
if(mysqli_num_rows($result) > 0)    
{
  ...
  $SQL = "SELECT PERDIEM , tbltravel_claim_info.`ID` as 'dID', `TC_ID`, `RO`, `DATE`, `PLACE`, `ARRIVAL`, `DEPARTURE`, `MOT`, `TRANSPORTATION`, `PERDIEM`, `RECEIPT`,`OTHERS`, `TOTAL_AMOUNT`,
...
$row11 = $lastRow+7;
    ...
    $objPHPExcel->getActiveSheet()->getStyle('E'.$lastRow)->applyFromArray($styleFontBold);
