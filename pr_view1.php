        ...
        <div class="box-body table-responsive no-padding">
          <div class="box-body">
           ...
           <?php if ($submitted_date == NULL): ?>
            <a class="btn btn-success " onclick="return confirm('Are you sure you want to Submit this PR?');" href='submit_pr1.php?id=<?php echo $id; ?>&username=<?php echo $username;?>'title="Submit"><i class="fa fa-fw fa-send-o"></i>Submit</a>
            <?php else: ?>
