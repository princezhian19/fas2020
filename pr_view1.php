    ...
    <div class="box">
      <div class="box-header with-border" align="left">
        ...
        <div class="box-body table-responsive no-padding">
          <div class="box-body">
           <a href="ViewPR1.php?division=<?php echo $division?>" class="btn btn-warning"><i class="fa fa-fw fa-arrow-left"></i>Back</a> 
           <?php if ($submitted_date == NULL): ?>
            <a class="btn btn-success btn-xs" onclick="return confirm('Are you sure you want to Submit this PR?');" href='submit_pr1.php?id=<?php echo $id; ?>&username=<?php echo $username;?>'title="Submit"><i class="fa fa-fw fa-send-o"></i>Submit</a>
            <?php else: ?>
            ...
            <?php if($submitted_date!=NULL):?>
              <?php else:?>
                <div style="float: right;padding:5px;">
                  <a href="ViewRFQdetails1.php?id=<?php echo $id; ?>" class="btn btn-primary"><i class='fa'>&#xf044;</i>Edit</a>
                </div>
