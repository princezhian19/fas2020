...
if (isset($_POST['submit'])) {
  ...
  {  
    ...
    VALUES("'.$_POST['pr_no'].'","'.$_POST['app_id'][$count].'","'.$_POST['items'][$count].'","'.$_POST['description'][$count].'","'.$unit[$count].'","'.$_POST['qty'][$count].'","'.$_POST['abc'][$count].'")');
   }
...
<body>
  <div class="box box-default">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>PR No.</label>
                  <input class="form-control" type="text" readonly name="pr" value="<?php echo $pr_no;?>">
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="date" class="form-control pull-right" readonly name="pr_date" value="<?php echo $pr_date;?>">
                  </div>
                </div>
                <div class="form-group">
                  <label>Purpose</label>
          ...
          <div class="panel-body container-items">
           ...
           <tr>
            ...
            while ($row = $sql_items->fetch()) {
              ...
              <td><input hidden type="text" name="items[]" value="<?php echo $items ?>"><?php echo $items?> </td>
   ...
   <button class="btn btn-primary" style="float: right;" type="submit" name="submit">Click to Finilize</button>
   <br>
   <br>
   <br>
 </form>
