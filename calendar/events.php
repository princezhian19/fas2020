...
if( !isset($_SESSION['inet_credentials']) )
{
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="../index.php">DILG LOOP</a>
			</div>
	...
	<div style="max-width: 1500px;">
		<div class="row">
			<div class="col-sm-12 text-center">
				<h1>DILG R4-A Calendar of Activities</h1>
				<div class="btn-group-primary">

					<a class="btn btn-primary" href="newevent.php"><span class="glyphicon glyphicon-plus-sign"></span> ADD EVENT</a>
					<?php 
						if ($isplanningofficer == '1') { ?>
							
								<a class="btn btn-danger" href="manageallevent.php"><span class="glyphicon glyphicon-edit"></span> MANAGE ALL EVENT</a>

					<?php } 

						else{ ?>
					<a class="btn btn-info" href="manageevent.php"><span class="glyphicon glyphicon-edit"></span> MANAGE EVENT</a>
					<?php } ?>
					<a class="btn btn-warning" href="eventLogs.php?log=addevent"><span class="glyphicon glyphicon-list-alt"></span> LOGS & <span class="glyphicon glyphicon-book"></span> REPORTS</a>
					<br><br>
				</div>
			</div>
		</div>
