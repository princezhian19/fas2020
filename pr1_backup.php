...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_num_rows($check)>0) {
    ...
    $insert_pr = mysqli_query($conn,"INSERT INTO pr(pr_no,pmo,purpose,pr_date,type,target_date) VALUES('$latest_pr_no','$pmo1','$purpose1','','$type','$d2')");
...
if (isset($_POST['add'])) {
  ...
  $check = mysqli_query($conn,"SELECT pr_no FROM pr WHERE pr_no = '$pr_no' ");
   ...
   if ($qty_original == 0 ) {
    echo "<div style='background-color:lightblue;color:red;'> <p> <b>No Item</b> <p> <div>";
      }
      else{   
