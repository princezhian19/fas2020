                                    ...
                                    <table id="example1" class="table table-striped table-bordered" style="background-color white;">
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($rowpo_no != ''): ?>
                                                ...
                                                <?php else: ?>
                                                    <td><i class="glyphicon glyphicon-link" style="margin-right4px;"></i><a class="btn btn-success btn-xs" href="CreateORSa.php?supplier_id=<?php echo $supplier_id;?>&po_no=<?php echo $po_no;?>&rfq_id=<?php echo $rfq_id;?>&supplier_titleD=<?php echo $supplier_titleD; ?>&supplier_address=<?php echo $supplier_addressD; ?>&po_amount=<?php echo $po_amount2; ?>">Obligation Request Status</a></td>
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                <?php if ($rowpo_no1 != ''): ?>
                                                      <td><i class="btn btn-success btn-xs" class="glyphicon glyphicon-link" style="margin-right4px;"></i><a href="UpdateDV.php?id=<?php echo $id;?>">Disbursement Voucher</a></td>
