...
<body>
  ...
  <div class="w3-sidebar w3-bar-block  w3-card" style="width:230px;">
    ...
    &nbsp&nbsp&nbsp<img src="to.png" width="45" height="45">&nbsp <p style="font-size: 10px;">
    &nbsp&nbsp&nbspFinancial and Adminisrative System</p>
    <p> &nbsp</p>
...
<a style="color:gray;font-weight: normal;" href="#">Update Requisition and Issue Slip</a>
</div>
<p></p>
