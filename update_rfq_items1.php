...
if (isset($_POST['submit'])) {
  ...
  $total_amount = $qty1 * $abc1;

  $UpdateRFQItems = mysqli_query($conn,"UPDATE rfq_items set app_id = '$idApp', unit_id = '$unit1', description = '$description1', qty ='$qty1', abc = '$abc1',total_amount = '$total_amount' WHERE rfq_id = '$rfqid' AND app_id = '$procurement");
  ...
  if ($UpdateItems) {
    ...
    window.location.href = 'ViewRFQdetails1.php?id=$id2';
    </SCRIPT>");
...
<?php $user = $_SESSION['username']; $QQ = mysqli_query($conn,"SELECT * FROM end_users WHERE username = '$user'");
  ...
  <div class="box box-default">
    <div class="box-header with-border">
      ...
      <br>
      &nbsp &nbsp &nbsp   <li class="btn btn-success"><?php echo '<a href="ViewRFQdetails1.php?id='.$id2.'" style="color:white;text-decoration: none;">Back</a>' ?> </li>
      ...
      //document.getElementById("abc").value = x[6].innerHTML;
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="unit" id="unit"  class="form-control"  value="<?php echo $unit?>"readonly>
