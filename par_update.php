...
$selectDetails = mysqli_query($conn,"SELECT EMP_N,par_date FROM par_assign WHERE ppe_id = $id ");
$rowD = mysqli_fetch_array($selectDetails);
$EMP_N = $rowD['EMP_N'];
$par_date = $rowD['par_date'];
...
if (isset($_POST['submit'])) {
  ...
  $insert_history = mysqli_query($conn,"INSERT INTO par_history(ppe_id,name,par_date) VALUES('$id','$name1','$par_date')");
  ...
  $insert_par = mysqli_query($conn,"INSERT INTO par_assign(ppe_id,EMP_N) 
    VALUES ('$id','$name1')");
