...
if (isset($_POST['submit'])) {
  ...
  $sqlUsername = mysqli_query($conn,"SELECT CODE FROM tblemployeinfo WHERE md5(UNAME) = '".md5($_POST['username'])."' LIMIT 1");
  $row = mysqli_fetch_array($sqlUsername);
  $salt       = $row['CODE'];
  $password  = crypt($_POST['password'], '$2a$10$'.$salt.'$');

  // ===============================================
  $query = "SELECT * FROM tblemployeinfo WHERE md5(UNAME) = '".md5($_POST['username'])."' AND PSWORD = '".$password."' AND ACTIVATED = 'Yes' AND BLOCK = 'N' LIMIT 1 ";
  ...
  // ===============================================
  // $sql = mysqli_query($conn,"SELECT * FROM tblemployeinfo WHERE md5(UNAME) = '".md5($_POST['username'])."' AND PSWORD = '".$password."' AND ACTIVATED = 'Yes' AND BLOCK = 'N' LIMIT 1");
