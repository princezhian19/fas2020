    ...
    <div class="box">
      <div class="box-body"> 
        ...
        <table id="example1" class="table table-striped table-bordered" style="background-color: white;">
          ...
          $QUERY = mysqli_query($conn, "SELECT tb.DIVISION_M,te.BLOCK,te.UNAME,te.EMP_N,te.LAST_M,te.MIDDLE_M,te.FIRST_M FROM tblemployeinfoinfo te  LEFT JOIN tblpersonneldivision tb on tb.DIVISION_N = te.DIVISION_C ORDER BY te.LAST_M ASC ");
